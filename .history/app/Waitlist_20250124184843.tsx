...
const Waitlist = () => {
    ...
    return (
        <div className="relative min-h-screen overflow-hidden bg-[var(--color-bg-primary)]">
            {/* Rotating Earth in background */}
            <div className="absolute inset-0 flex items-center justify-center opacity-5">
                <Globe2 className="w-[800px] h-[800px] animate-slow-spin text-[var(--color-primary-200)]" />
            </div>
            ...
            <div className="absolute inset-0 pointer-events-none">
                <Icon 
                    ...
                    className="absolute top-20 left-[20%] w-8 h-8 animate-float text-[var(--color-primary-200)]" 
                />
                <Icon 
                    icon="cryptocurrency:eur" 
                    className="absolute top-40 right-[25%] w-8 h-8 animate-float animation-delay-2000 text-[var(--color-primary-300)]" 
                />
                <Bitcoin 
                    className="absolute bottom-40 left-[30%] w-8 h-8 animate-float animation-delay-4000 text-[var(--color-primary-400)]" 
                />
                <DollarSign 
                    className="absolute top-60 right-[15%] w-8 h-8 animate-float animation-delay-6000 text-[var(--color-primary-500)]" 
                />
            </div>
            ...
            <div className="relative flex flex-col min-h-screen">
                <header className="justify-center items-center pt-16 px-4">
                    <div className="flex justify-center mb-4">
                        <Badge variant="secondary" className="text-sm font-medium tracking-wider animate-pulse shadow-lg">
