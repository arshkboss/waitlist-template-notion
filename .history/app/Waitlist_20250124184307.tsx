...
const Waitlist = () => {
    ...
    return (
        <div className="relative min-h-screen overflow-hidden bg-[#e5e5ee]">
            ...
            <div className="absolute top-0 -left-20 w-[600px] h-[600px] bg-[#3ab7f6] rounded-full mix-blend-multiply filter blur-3xl opacity-70 animate-morph"></div>
            ...
            <div className="relative flex flex-col min-h-screen">
                <header className="justify-center items-center pt-32">
                    <p className="text-sm font-medium text-[#90E0EF] mb-4 tracking-wider uppercase text-center ">Gyre App | End-to-end CRM</p>
                    <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 tracking-tight text-center">
                        Join the waitlist for
                    </h1>
                    <h2 className="text-4xl md:text-6xl font-bold bg-gradient-to-r from-[#48CAE4] via-[#90E0EF] to-[#CAF0F8] text-transparent bg-clip-text mb-8 text-center">
