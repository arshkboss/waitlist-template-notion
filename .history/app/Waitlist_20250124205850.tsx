...
const FloatingSymbols = () => (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {CURRENCY_SYMBOLS.map((symbol, i) => (
            <div
                key={i}
                className={`absolute text-white/[0.03] animate-float-random select-none
                           backdrop-blur-sm text-2xl md:text-3xl font-bold
    ...
    return (
        <div className="relative min-h-screen overflow-hidden bg-[#0a0f1c] flex">
            ...
            <div className="absolute right-0 top-0 w-1/3 h-full overflow-hidden">
                ...
                {[...Array(15)].map((_, i) => (
                    <div
                        ...
                        style={{
                            left: `${i * (100 / 15)}%`,
                            width: `${100 / 15}%`,
                            backdropFilter: `blur(${8 + (i % 5) * 3}px)`, // Varied blur
                            opacity: 0.01 + (i % 4) * 0.008, // Subtle opacity variation
                            transform: `translateZ(${i * 0.5}px) scaleX(${0.9 + (i % 3) * 0.1})`, // Varied depth and width
                        }}
                    />
                ))}
                ...
                <div className="absolute inset-0 backdrop-blur-2xl bg-white/[0.01] transform translate-x-4" />
                ...
                <div className="w-full md:w-1/3 p-4 md:p-8 lg:p-16 flex items-center justify-center relative">
                    <div className="w-full max-w-md animate-fade-in-up delay-500 relative z-10">
                        ...
                        <form 
                            ...
                            className="relative space-y-6 rounded-2xl p-6 md:p-8 border border-white/10 
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-10 pr-4 py-3 rounded-xl border border-white/10 
                                                 bg-white/[0.03] text-white placeholder-white/40 
