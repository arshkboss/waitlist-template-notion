                    ...
                    <div className="w-full max-w-md">
                        <div className="relative">
                            ...
                            <form 
                                ...
                                className="relative space-y-4 bg-white/90 rounded-2xl p-8 shadow-lg transform transition-all hover:scale-[1.02]"
                            >
                                <div className="space-y-2">
                                    <input
                                        type="text"
                                        placeholder="Full name..."
                                        className="w-full px-4 py-3 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all bg-white"
                                    />
                                </div>
                                <div className="space-y-2">
                                    <input
