...
const DATABASE_ID = process.env.DATABASE_ID; // Replace with your actual database ID
const NOTION_API_KEY = process.env.NOTION_API_KEY; // Replace with your actual integration token
