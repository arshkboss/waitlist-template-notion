...
const FloatingSymbols = () => (
  <div className="absolute inset-0 overflow-hidden pointer-events-none">
    {/* Large Symbols */}
    <div className="absolute text-white/[0.02] text-6xl font-bold rotate-12 left-[10%] top-[15%]">
      ₹
    </div>
    <div className="absolute text-white/[0.03] text-5xl font-bold -rotate-15 right-[15%] top-[25%]">
      $
    </div>
    <div className="absolute text-white/[0.015] text-7xl font-bold rotate-45 left-[20%] top-[45%]">
      €
    </div>

    {/* Medium Symbols */}
    <div className="absolute text-white/[0.025] text-4xl font-bold -rotate-12 right-[25%] top-[40%]">
      £
    </div>
    <div className="absolute text-white/[0.02] text-5xl font-bold rotate-90 left-[30%] top-[60%]">
      ¥
    </div>
    <div className="absolute text-white/[0.015] text-4xl font-bold rotate-180 right-[20%] top-[55%]">
      ₹
    </div>

    <div className="absolute text-white/[0.025] text-4xl font-bold -rotate-12 right-[15%] top-[70%]">
      ₡
    </div>
    <div className="absolute text-white/[0.02] text-5xl font-bold rotate-90 left-[10%] top-[30%]">
      ₦
    </div>
    <div className="absolute text-white/[0.015] text-4xl font-bold rotate-180 right-[20%] top-[55%]">
      ₭
    ...
    {/* Small Symbols */}
    <div className="absolute text-white/[0.03] text-3xl font-bold rotate-45 left-[15%] bottom-[25%]">
      ₽
    </div>
    <div className="absolute text-white/[0.02] text-3xl font-bold -rotate-45 right-[30%] bottom-[35%]">
      ₸
    </div>
    <div className="absolute text-white/[0.025] text-2xl font-bold rotate-12 left-[25%] bottom-[20%]">
      ₮
    </div>

    {/* Extra Small Symbols */}
    <div className="absolute text-white/[0.015] text-2xl font-bold -rotate-90 right-[10%] bottom-[15%]">
      ₩
    </div>
    <div className="absolute text-white/[0.02] text-xl font-bold rotate-135 left-[35%] bottom-[30%]">
      ₴
    </div>
    <div className="absolute text-white/[0.03] text-xl font-bold -rotate-135 right-[35%] bottom-[25%]">
      ₫
    </div>
  </div>
);
...
const Waitlist = () => {
  ...
  return (
    <>
      <div className="relative min-h-screen overflow-hidden bg-[#0a0f1c] flex flex-col">
        ...
        {/* Main Content */}
        <div className="relative w-full flex flex-col md:flex-row flex-grow">
          {/* Left Side Content */}
          <div className="w-full md:w-2/3 p-4 md:p-8 lg:p-16 flex flex-col justify-center">
            <div className="mb-8 ">
              <Badge
                variant="secondary"
                className="text-sm font-medium tracking-wider shadow-lg mb-4 hover:shadow-xl"
              >
                <Icon
              ...
              >
                ...
                <br />
                <span
                  className="bg-gradient-to-r from-[#c8eff7] via-[#0096C7] to-[#023E8A] 
              ...
              <p
                className="text-[#90E0EF]/80 text-base sm:text-lg md:text-xl leading-relaxed 
                                     max-w-xl "
              >
                Experience the future of payments. Break through traditional
                barriers with our revolutionary cross-border payment platform.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6 mt-8 md:mt-12 max-w-4xl">
              <FeatureCard
                icon={<Globe className="w-6 h-6 text-[#48CAE4] " />}
                title="Global Coverage"
                description="160+ countries supported"
              />
              <FeatureCard
                icon={<Shield className="w-6 h-6 text-[#48CAE4]" />}
                title="Bank-Grade Security"
                description="End-to-end encryption"
              />
              <FeatureCard
                icon={<Clock className="w-6 h-6 text-[#48CAE4] " />}
                title="Instant Transfers"
                description="24/7 real-time processing"
              />
              <FeatureCard
                icon={<CreditCard className="w-6 h-6 text-[#48CAE4] " />}
                title="Low Fees"
        ...
        {/* Footer */}
        <footer className="relative w-full py-4 flex flex-col items-center justify-center bg-transparent z-10">
...
const FeatureCard = ({ icon, title, description }: FeatureCardProps) => (
  <div
    className={`p-6 rounded-xl bg-white/[0.03] backdrop-blur-md border border-white/10 
