            ...
            <div className="relative w-full flex flex-col md:flex-row">
                ...
                <div className="w-full md:w-1/2 p-8 md:p-16 flex flex-col justify-center">
                    <div className="mb-8 animate-fade-in-up">
                        <Badge variant="secondary" className="text-sm font-medium tracking-wider animate-pulse shadow-lg mb-4 hover:scale-105 transition-transform">
                            <Icon icon="cryptocurrency:usd" className="w-4 h-4 mr-2 animate-bounce" />
                        ...
                        <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 tracking-tight animate-fade-in-up delay-100">
                            Immerse Yourself in
                            <br />
                            <span className="bg-gradient-to-r from-[#48CAE4] via-[#0096C7] to-[#023E8A] text-transparent bg-clip-text animate-gradient">
                                Refracted Payments
                            </span>
                        </h1>
