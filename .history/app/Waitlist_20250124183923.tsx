...
const Waitlist = () => {
    ...
    return (
        <div className="relative min-h-screen overflow-hidden bg-[#03045E]">
            {/* Larger, morphing gradient blobs */}
            <div className="absolute top-0 -left-20 w-[600px] h-[600px] bg-[#c2cddc] rounded-full mix-blend-multiply filter blur-3xl opacity-70 animate-morph"></div>
            <div className="absolute top-40 -right-20 w-[600px] h-[600px] bg-[#0077B6] rounded-full mix-blend-multiply filter blur-3xl opacity-70 animate-morph animation-delay-2000"></div>
            <div className="absolute -bottom-40 left-40 w-[600px] h-[600px] bg-[#0096C7] rounded-full mix-blend-multiply filter blur-3xl opacity-70 animate-morph animation-delay-4000"></div>
