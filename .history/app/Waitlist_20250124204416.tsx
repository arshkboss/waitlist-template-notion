...
const Waitlist = () => {
    ...
    return (
        <div className="relative min-h-screen overflow-hidden bg-[#0a0f1c] flex">
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-[#7CD2E3FF] via-[#12495a] to-[#023E8A]/50" />
            
            {/* Vertical Fluted Glass Effect - Right side only */}
            <div className="absolute right-0 top-0 w-1/3 h-full overflow-hidden">
                {[...Array(15)].map((_, i) => (
                    <div
                        ...
                        style={{
                            left: `${i * (100 / 15)}%`,
                            width: `${100 / 15}%`,
                            backdropFilter: `blur(${12 + (i % 3) * 4}px)`,
                ...
                <div className="absolute inset-0 backdrop-blur-2xl bg-white/[0.01] transform translate-x-2" />
                <div className="absolute inset-0 backdrop-blur-xl bg-white/[0.01] transform -translate-x-2" />
            </div>
                ...
                <div className="w-full md:w-1/3 p-8 md:p-16 flex items-center justify-center relative">
                    <div className="w-full max-w-md animate-fade-in-up delay-500 relative z-10">
                        <div className="relative group">
                            {/* Form glass effect */}
                            <div className="absolute inset-0 backdrop-blur-3xl rounded-2xl bg-white/[0.03] group-hover:bg-white/[0.04] transition-colors" />
                            <div className="absolute inset-2 backdrop-blur-2xl rounded-xl bg-white/[0.02]" />
